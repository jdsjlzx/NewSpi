...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>serviceloader</b> with <b>com.lzx.spi:serviceloader</b> coordinates and
     * with version reference <b>serviceloader</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getServiceloader() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("serviceloader");
    }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>serviceloader</b> with value <b>0.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getServiceloader() { return getVersion("serviceloader"); }

        /**
         * Version alias <b>spipluginversion</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSpipluginversion() { return getVersion("spipluginversion"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final SpiPluginAccessors paccForSpiPluginAccessors = new SpiPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.spi</b>
         */
        public SpiPluginAccessors getSpi() {
            return paccForSpiPluginAccessors;
        }
    ...
    public static class SpiPluginAccessors extends PluginFactory {

        public SpiPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>spi.plugin</b> with plugin id <b>com.lzx.spi.spi-plugin</b> and
         * with version reference <b>spipluginversion</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugin() { return createPlugin("spi.plugin"); }
